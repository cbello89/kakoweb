    ...
    <div class="row">
        <div class="col-md-6" style="margin-top: 150px">
            <div class="row wowload fadeInLeft">
                <h2 class="text-center wowload fadeInUp">The most beautiful land</h2>
            </div>
            <div class="row wowload fadeInLeft">
                <p><strong>(2010-2014) </strong>“This is the most beautiful land that human eyes has seen” said sententiously
                    Cristopher Colombus gazing at the Cuban shore. 15 Cuban landscapes, from the higher mountains to the sea. In the
                    middle, the Human being, because what makes a landscape great is not framing or composition: is more about how
                    small can make us feel compared with Nature's work.</p>
                <p> This series is a tribute to Tomas Sánchez, Cuban painter master of landscape: first lesson in fine arts, not yet ended.</p>
            </div>

            <div class="row wowload fadeInLeft">
                <div class="col-md-12 text-center ">
                    <a class="btn btn-primary" href="./images/pdf/003%20La%20tierra%20más%20hermosa%20EN%20web.pdf"><i class="fa fa-download"></i> Download PDF</a>
                </div>
            </div>
