    ...
    <div class="row">
        <div class="col-md-6" style="margin-top: 150px">
            <div class="row wowload fadeInLeft">
                <h2 class="text-center wowload fadeInUp">Common Places</h2>
            </div>
            <div class="row wowload fadeInLeft">
                <p><strong>(2014-2016) </strong>A game of chess on the street, a phone call in the middle of the
                    crowd, commuters returning home by train. Everyday life of ordinary people both in Cuba and the
                    US. Images like mirrors showing how humans are we, even being born in different cultures and
                    speaking different languages. Mirrors, for look inside ourselves and reconsider how much we have
                    assumed for decades about what “the other shore” is.</p>
            </div>

            <div class="row wowload fadeInLeft">
                <div class="col-md-12 text-center ">
                    <a class="btn btn-primary" href="./images/pdf/004_common_places_ES-EN_DEMO_v0.96_web.pdf"><i class="fa fa-download"></i> Download PDF</a>
                </div>
            </div>
