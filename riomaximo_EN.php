    ...
    <div class="row">
        <div class="col-md-6" style="margin-top: 150px">
            <div class="row wowload fadeInLeft">
                <h2 class="text-center wowload fadeInUp" style="margin-left: 15px">The pink Flamingos of Maximo river</h2>
            </div>
            <div class="row wowload fadeInLeft">
                <p>The crowd of birds surrounded by men and children of Mola is almost here.
                    The sound is the chorus of the voices of the humans and the honking of the birds.
                    All of them march together, and there´s something strange and magic here:
                    an energy that comes from the communion between the man and the animal who is not led to a corral or a slaughterhouse,
                    but the place they´re going to be studied and cared. </p>
            </div>

            <div class="row wowload fadeInLeft">
                <div class="col-md-12 text-center ">
                    <a class="btn btn-primary" href="http://oncubamagazine.com/oncuba-media/los-flamencos-rosados-de-rio-maximo/"><i class="fa fa-sign-in"></i> Go to the Reportage</a>
                </div>
            </div>
