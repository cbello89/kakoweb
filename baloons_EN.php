...
$query_baloons="SELECT * FROM fotos WHERE Subcategory='baloons'";
$getfotos_baloons = mysqli_query($kako, $query_baloons);
    ...
    <div class="row">
        <div class="col-md-6" style="margin-top: 150px">
            <div class="row wowload fadeInLeft">
                <h2 class="text-center wowload fadeInUp" style="margin-left: 15px">Rubber match: Men vs. Fish in Cuba</h2>
            </div>
            <div class="row wowload fadeInLeft">
                <p>To get around the restrictions, someone had the brilliant idea of using the coastal stream of salt water toward the west and the wind draft from the sea to the north. Together wind and tide take fishing lines 700 meters out to sea, where the ´big fishes´ are. Balloons where tied to the lines, catching both the current and the winds and pulling lines out.</p>
            </div>

            <div class="row wowload fadeInLeft">
                <div class="col-md-12 text-center ">
                    <a class="btn btn-primary" href="https://thestandglobal.com/rubber-match-man-vs-fish-in-cuba/"><i class="fa fa-sign-in"></i> Go to the reportage</a>
                </div>
            </div>
        ...
        <div class="col-md-6 wowload fadeInLeft">
            <?php
                while($result_baloons=mysqli_fetch_assoc($getfotos_baloons)){
                    $photo_path=$dir.$result_baloons["Category"].'/'.$result_baloons["Subcategory"].'/'.$result_baloons["F_name"];
